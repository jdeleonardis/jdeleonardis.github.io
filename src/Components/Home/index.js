            ...
            <section className="col-lg-12">                
                <div style={styles.leftBox}>                                    
                    ...
                    <div id="social_media_icons">
                        <a href="https://www.linkedin.com/in/jamesdeleonardis/" target="_blank" className="fa fa-linkedin" rel="noopener noreferrer"> </a>        
                        <a href="https://github.com/jdeleonardis" target="_blank" className="fa fa-github" rel="noopener noreferrer"> </a>              
                    </div>
